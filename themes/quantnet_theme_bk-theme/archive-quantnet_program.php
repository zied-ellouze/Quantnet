	...
	<div id="content" role="main">
		...
		<?php if($wpsc_query->have_posts()) : ?>
			<div class="navigation">
				<a href="<?php echo parse_url($_SERVER['REQUEST_URI'],PHP_URL_PATH);?>">Rating</a> - <a href="<?php echo parse_url($_SERVER['REQUEST_URI'],PHP_URL_PATH);?>?sort=name">Program Name</a> - <a href="<?php echo parse_url($_SERVER['REQUEST_URI'],PHP_URL_PATH);?>?sort=reviews">Number of Reviews</a>
			</div>
				...
				<div id="post" <?php post_class(); ?>>
					<div class="entry-summary">
						...
						<div class="main-entry-desc">
							...
							<p class="write-a-review"><a href="<?php the_permalink(); ?>?review=true">Write A Review</a></p>
						</div>
					</div><!-- .entry-summary -->
				</div><!--post-->
				<?php //end loop ?>
