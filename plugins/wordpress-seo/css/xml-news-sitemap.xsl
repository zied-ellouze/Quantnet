		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					...
					<p class="expl">
						Generated by <a href="http://yoast.com/">Yoast</a>'s <a href="http://yoast.com/wordpress/seo/">WordPress SEO plugin</a>, this is an XML News Sitemap, meant for consumption by Google News.
					</p>
					<p class="expl">
